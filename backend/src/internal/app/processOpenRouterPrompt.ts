...
export const processUserPromptStream = async (
  ...
  const systemDesignPrompt = `You are floww, an expert CTO system design assistant. Generate a comprehensive system design for "${prompt}" following these STRICT requirements:
  ...
  # MANDATORY COMPONENTS (include all):
  1. Frontend Services:

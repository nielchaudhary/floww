        ...
        <div className="relative z-10 flex flex-col items-center justify-center">
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 space-x-0 md:space-x-4">
            <button
              ...
              className="group/btn relative flex shadow-input w-40 h-10 rounded-xl font-bold bg-black border-transparent text-white text-sm  dark:bg-zinc-900  dark:shadow-[0px_0px_1px_1px_#262626]"
            >
              →
              <BottomGradient />
            </button>

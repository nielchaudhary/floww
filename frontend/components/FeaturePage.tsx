...
export function FeaturePage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        'Our reliable infrastructure ensures your workflow creation is never interrupted.',
      icon: <IconCloud />,
    },
    {
    ...
    },
    {
      ...
      description: 'Get help anytime with our responsive support team and AI-powered assistance.',
      icon: <IconClock24 />,
    },
    {
    ...
    },
    {
      ...
      description:
        'Take your designs anywhere with exports to Figma, Miro, or as ready-to-use code snippets.',
      icon: <IconFileExport />,
    },
  ];
  return (
    <>
      ...
      <div className="relative bg-black flex flex-col items-center justify-center min-h-screen w-screen overflow-x-hidden overflow-y-hidden py-10">
        ...
        >
          ...
          <button
            className="group/btn relative shadow-input w-40 h-10 rounded-xl font-bold bg-black border-transparent text-white text-sm mt-8 relative z-10 dark:bg-zinc-900 dark:shadow-[0px_0px_1px_1px_#262626]"
